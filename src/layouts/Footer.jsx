...
export const Footer = () => {
  return <footer className="bg-slate-900 border-t border-slate-800 text-slate-400 py-12 px-4 sm:px-6 lg:px-8 mt-auto">
    ...
    /* Quick Links */
        ...
        <div>
          ...
          <ul className="space-y-2 text-xs">
            ...
            <li><Link to="/opportunities" className="hover:text-white transition-colors">Assemble Collaborators</Link></li>
    ...
    /* Contact Info */
        ...
        <div>
          ...
          <ul className="space-y-2.5 text-xs text-slate-400">
            <li className="flex items-center gap-2">
              ...
              <span>SOMA District, San Francisco, CA</span>
            </li>
            <li className="flex items-center gap-2">
              <Mail size={14} className="text-primary flex-shrink-0" />
              <a href="mailto:support@startupforge.co" className="hover:text-white transition-colors">support@startupforge.co</a>
            </li>
            <li className="flex items-center gap-2">
      ...
      <div className="max-w-7xl mx-auto border-t border-slate-800 mt-10 pt-6 flex flex-col sm:flex-row justify-between items-center text-slate-500 text-[11px] gap-4">
        <p>© 2026 StartupForge. All rights strictly reserved. An AI Studio built platform.</p>
